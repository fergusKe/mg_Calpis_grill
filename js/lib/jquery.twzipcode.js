        ...
        geoLocation: function () {
            ...
            geolocation.getCurrentPosition(
                        ...
                        $.getJSON(
                            ...
                            function (data) {
                                ...
                                if (data &&
									...
									if (window.twzipcodeready) {  
										twzipcodeready(true);  
									} else {  
										_twzipcodeready(true);
									}
                                }
                            });
                    }
                ...
                function (error) {
					...
					if (window.twzipcodeready) {  
						twzipcodeready(false);  
					} else {  
						_twzipcodeready(false);
					}
					//console.error(error);
                },
                options
